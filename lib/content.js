...
// UI copy that used to be hard-coded inside components.
export const copy = {
  meta: {
  ...
  hero: {
    lead: 'we are',
    stack: ['a design', '& motion'],
    tail: 'studio',
    since: 'since',
    intro: 'Brand systems, websites and motion for people who care how things are made.',
    reel: 'Play the reel',
  },
  // The showreel modal plays this file; the button stays hidden until it exists.
  reel: '/reel.mp4',
  marquee: { top: 'Now booking projects for 2027', footer: 'Start a project' },
  labels: {
    statement: 'The studio',
    services: 'What we do',
    cases: ['Selected', 'cases'],
    awards: ['Awards &', 'recognition'],
    footer: ['Have something', 'in mind?'],
    backToTop: 'Back to top',
    menuOpen: 'Menu',
    menuClose: 'Close',
    reelClose: 'Close',
  },
  badges: { statement: 'read more about us ✺ ', explore: 'explore case ✺ ' },
};
